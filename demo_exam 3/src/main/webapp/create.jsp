...
<body>
<h2 align="center">Thêm mới bài học</h2>

<c:if test="${message != null} ">
    <span id="message">${message}</span>
</c:if>

<form method="post" action="/BaiHocServlet?action=them" style="text-align: center;display: flex;justify-content: center">
    <table border="1" cellpadding="5">
        <tr>
            <th>Tiêu đề :</th>
            <td>
                <input type="text" name="tieuDe" id="name"/>
            </td>
        </tr>
        <tr>
            <th>Loại bài học :</th>
