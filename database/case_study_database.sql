...
count(hop_dong.ma_khach_hang) as so_lan_dat_phong from khach_hang
...
select khach_hang.ma_khach_hang, khach_hang.ho_va_ten, loai_khach.ten_loai_khach, hop_dong.ma_hop_dong, dich_vu.ten_dich_vu,
hop_dong.ngay_lam_hop_dong, hop_dong.ngay_ket_thuc_hop_dong, 
ifnull(hop_dong_chi_tiet.so_luong *dich_vu_di_kem.gia) + dich_vu.chi_phi_thue as tong_tien
from khach_hang
left join hop_dong on 